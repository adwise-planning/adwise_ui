    ...
    return Column(
      ...
      children: [
        Container(
          ...
          // Container for input field background
          decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(15),
              color: widget.isDarkMode
                  ? Colors.grey[800]
                  : Colors.white, // White for light mode input
              border: Border(
                top: BorderSide(
              ...
              Expanded(
                child: TextFormField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    //     color:
                    //         Colors.redAccent), // Error text style - Red accent
                  ),
                  onChanged: (value) {
                    // Set phoneTouched when user starts typing
                    setState(() {
                      phoneTouched = true;
                    });
                  },
        ...
        //       left: 12.0, top: 5.0), // Indented and spaced from input
        //   child: Builder(
        //     // Using Builder to get context for Theme
        //     builder: (context) {
        //       final error =
        //           Validators.phoneValidator(widget.phoneController.text);
        //       return (phoneTouched &&
        //               error != null) // Show error only if touched AND invalid
        //           ? Text(error,
        //               style: TextStyle(
        //                   color: Theme.of(context).colorScheme.error,
        //                   fontSize: 12)) // Use theme error color
        ...
        children: [
          ...
          TextFormField(
            ...
            decoration: const InputDecoration(
              ...
              errorStyle: TextStyle(
                  color: Colors.redAccent), // Error text style - Red accent
            ),
            onChanged: (value) {
              // Set emailTouched when user starts typing
              setState(() {
                emailTouched = true;
              });
            },
          ...
          // Padding(
          //   // Error message for Email - Conditional Display
          //   padding: const EdgeInsets.only(
          //       left: 12.0, bottom: 8.0), // Indented and spaced
          //   child: Builder(
          //     // Using Builder to get context for Theme
          //     builder: (context) {
          //       final error =
          //           Validators.emailValidator(widget.emailController.text);
          //       return (emailTouched &&
          //               error != null) // Show error only if touched AND invalid
          //           ? Text(error,
          //               style: TextStyle(
          ...
          TextFormField(
            ...
            onChanged: (value) {
              // Set passwordTouched when user starts typing
              setState(() {
                passwordTouched = true;
              });
            },
            validator: (value) => passwordTouched
                ? Validators.passwordValidator(value)
                : null, // Validate only if touched
          ),
          // Padding(
          //   // Error message for Password - Conditional Display
          //   padding: const EdgeInsets.only(
          //       left: 12.0, top: 5.0), // Indented and spaced
          //   child: Builder(
          //     // Using Builder to get context for Theme
          //     builder: (context) {
          //       final error = Validators.passwordValidator(
